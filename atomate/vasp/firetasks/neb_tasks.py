...
from pymacy.neb.parse import NEBDBManager
from pymacy.utils.log_utils import get_logger
...
# TODO - Next step:
#       2) Enable chain-neb
#       5) Add VaspNEBJob to job.py
#       8) Add pathfinder module
...
logger = get_logger(__name__, level=logging.DEBUG, filename="run.log")
