...
from atomate.vasp.workflows.presets.core import wf_neb_spectra
...
class TestNudgedElasticBandWorkflow(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.neb_config = {"modes": [0, 1], "step_size": 0.005,
                          "vasp_cmd": ">>vasp_cmd<<", "db_file": ">>db_file<<"}
        cls.wf = wf_neb_spectra(cls.struct_si, cls.neb_config)
